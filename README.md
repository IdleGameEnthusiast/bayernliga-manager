...
| `engine/drift.js` | Was das Commitment ohne Gespräch bewegt, für jeden Verein: die Betreuung durch den Coach als Faktor auf jeden Verlust, die verletzte Woche, die Niederlagenserie, das Jahr im Verein, der jährliche Ausgleich für die KI — und die Trend-Nachricht, mit der der Coach einen Stufenwechsel meldet oder eben nicht |
